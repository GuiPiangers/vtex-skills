...
![{"base64":"  ","img":{"width":2878,"height":1638,"type":"png","mime":"image/png","wUnits":"px","hUnits":"px","length":927135,"url":"https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/images/vtex-product-customizer-0.png"}}](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/images/vtex-product-customizer-0.png)

_Example of a PDP with the Product Customizer component displaying product attachments._
...
![{"base64":"  ","img":{"width":2860,"height":1438,"type":"gif","mime":"image/gif","wUnits":"px","hUnits":"px","length":526825,"url":"https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/images/vtex-product-customizer-1.gif"}}](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/images/vtex-product-customizer-1.gif)

_Example of a PDP with the Product Customizer component displaying the product subscription._
...
```
  ...
  3. Declare the `product-assembly-options` props for your scenario.
...
`assembly-option-item-children-description`| Displays a summary with all selected attachments.  
  ...
  3. Declare the props for the chosen blocks according to your scenario. For example:
...
![{"base64":"  ","img":{"width":1180,"height":736,"type":"png","mime":"image/png","wUnits":"px","hUnits":"px","length":64908,"url":"https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/images/vtex-product-customizer-2.png"}}](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/images/vtex-product-customizer-2.png)

Check out below how the product attachment displayed above was added to the Catalog:

![{"base64":"  ","img":{"width":2268,"height":1088,"type":"png","mime":"image/png","wUnits":"px","hUnits":"px","length":189056,"url":"https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/images/vtex-product-customizer-3.png"}}](https://cdn.jsdelivr.net/gh/vtexdocs/dev-portal-content@main/images/vtex-product-customizer-3.png)
