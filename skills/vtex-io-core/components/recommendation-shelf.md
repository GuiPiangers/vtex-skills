...
![{"base64":"  ","img":{"width":3170,"height":1406,"type":"png","mime":"image/png","wUnits":"px","hUnits":"px","length":1264326,"url":"https://cdn.jsdelivr.net/gh/vtex-apps/recommendation-shelf@master/docs/shelf.png"}}](https://cdn.jsdelivr.net/gh/vtex-apps/recommendation-shelf@master/docs/shelf.png)

> Learn more about [Product Recommendations](<https://help.vtex.com/en/tutorial/product-recommendations-beta--2QIexbD2FSXBxELUnFtg7g>).
